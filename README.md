...
* data/
Raw data collected from ANES 2016 along with datasets recording several intermediary and final steps of analysis.

* figs/
Contains all figures used within the paper along with key calculations.
